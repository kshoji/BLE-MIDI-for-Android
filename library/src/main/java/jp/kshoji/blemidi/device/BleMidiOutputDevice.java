 ...
 */
public class BleMidiOutputDevice {

    private BluetoothGattCharacteristic midiOutputCharacteristic;
    private final BluetoothGatt bluetoothGatt;

    /**
     * Obtains BleMidiOutputDevice instance if available from specified BluetoothGatt
     *
     * @param context
     * @param bluetoothGatt
     * @return null if the device doesn't contain BLE MIDI service
     */
    public static BleMidiOutputDevice getInstance(final Context context, final BluetoothGatt bluetoothGatt) {
        // create instance if available
        try {
            return new BleMidiOutputDevice(context, bluetoothGatt);
     ...
     */
    private BleMidiOutputDevice(final Context context, final BluetoothGatt bluetoothGatt) throws IllegalArgumentException {
