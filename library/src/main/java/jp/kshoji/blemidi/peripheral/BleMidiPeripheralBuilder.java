...
public class BleMidiPeripheralBuilder {
    ...
    public static BleMidiPeripheralBuilder getInstance(Context context) {
        return new BleMidiPeripheralBuilder(context);
    }
     ...
     * @param context
     */
    private BleMidiPeripheralBuilder(Context context) {
